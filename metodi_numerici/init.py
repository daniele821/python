...
x1, _, res1 = roots.bisection(func, 1.5, 2.5, 1e-2)
x2, _, res2 = roots.bisection(func, 2.5, 3.5, 1e-2)
x3, _, res3 = roots.bisection(func, 3.5, 4.5, 1e-2)
x4, _, res4 = roots.bisection(func, 4.5, 5.2, 1e-2)
