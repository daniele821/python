...
roots.animate(func, bis1, 1.5, 2.5, opts=bisopts)
roots.animate(func, bis2, 2.5, 3.5, opts=bisopts)
roots.animate(func, bis3, 3.5, 4.5, opts=bisopts)
roots.animate(func, bis4, 4.5, 5.2, opts=bisopts)
roots.animate(func, fal1, 1.5, 2.5, opts=falopts)
roots.animate(func, fal2, 2.5, 3.5, opts=falopts)
roots.animate(func, fal3, 3.5, 4.5, opts=falopts)
roots.animate(func, fal4, 4.5, 5.2, opts=falopts)
roots.animate(func, cor1, 1.5, 2.5, x0=1.5, opts=coropts)
roots.animate(func, cor2, 2.5, 3.5, x0=2.5, opts=coropts)
roots.animate(func, cor3, 3.5, 4.5, x0=3.5, opts=coropts)
roots.animate(func, cor4, 4.5, 5.2, x0=4.5, opts=coropts)
